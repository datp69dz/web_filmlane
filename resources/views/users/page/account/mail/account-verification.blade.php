...
<body style="background: #F9F9F9;">
                                            ...
                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="vertical-align:undefined;width:640px;">
                                                        <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">Welcome to FilmLane!</div><!--[if mso | IE]>
                                                    </td>
                                                </tr>
                                            </table>
  ...
  <p>Thank you for registering an account with FilmLane. Before you can start our movie collection rewards, we kindly ask you to verify your email address by clicking the validate button below:
    If you have not registered an account on Film Streaming, please ignore this email. Maybe someone mistyped your email address.</p>

  
            </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;" align="center" valign="middle" bgcolor="#7289DA"><a href="{{ route('account.verify', ['token' => $token['token']]) }}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
              Verify Email
